...
try:
    ...
    from new.data.datamodule import EdgeFaceDataModule
    from new.lightning_utils.callbacks import FaceVerificationCallback
    from new.lightning_utils.config import get_config
    from new.models.module import EdgeFaceModule
