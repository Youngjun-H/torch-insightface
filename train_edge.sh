#!/bin/bash
# =============================================================================
# ArcFace Training SLURM Script
# 
# 사용법:
#   아래 #SBATCH 지시어에서 노드 수와 GPU 수만 수정하면 됩니다!
#   스크립트가 SLURM 환경 변수를 자동으로 감지하여 사용합니다.
# =============================================================================
...
srun python -m edgeface_lightning.train \
    edgeface_lightning/configs/edgeface_xs_gamma_06.py \
